export default function Mission() {
  return (
    <div className="container mx-auto px-4 py-8">
      <section className="mb-12 p-8 bg-white rounded-lg shadow-inner border border-gray-200">
        <h2 className="text-3xl font-bold text-gray-800 mb-6">Our Mission</h2>
        <p className="text-lg text-gray-700 font-light leading-relaxed whitespace-pre-wrap">
